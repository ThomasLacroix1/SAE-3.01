...
class Product implements JsonSerializable {
    ...
    private string $option_edition; // id de la catégorie du produit
    ...
    /**
     * Get the value of option_edition
     */ 
    public function getOption_edition()
    {
        return $this->option_edition;
    }

    /**
     * Set the value of option_edition
     *
     * @return  self
     */ 
    public function setOption_edition($option_edition)
    {
        $this->option_edition = $option_edition;

        return $this;
    }

    /**
     * Get the value of option_plateforme
     */ 
    public function getOption_plateforme()
    {
        return $this->option_plateforme;
    }

    /**
     * Set the value of option_plateforme
     *
     * @return  self
     */ 
    public function setOption_plateforme($option_plateforme)
    {
        $this->option_plateforme = $option_plateforme;

        return $this;
    }

    /**
     * Get the value of option_taille
     */ 
    public function getOption_taille()
    {
        return $this->option_taille;
    }

    /**
     * Set the value of option_taille
     *
     * @return  self
     */ 
    public function setOption_taille($option_taille)
    {
        $this->option_taille = $option_taille;

        return $this;
    }

    /**
     * Get the value of option_collector
     */ 
    public function getOption_collector()
    {
        return $this->option_collector;
    }

    /**
     * Set the value of option_collector
     *
     * @return  self
     */ 
